...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /api/devices/{serial}/source", s.DeviceSource)
	mux.HandleFunc("POST /api/control/find-elements", s.FindElements)
	mux.HandleFunc("POST /api/control/find-element", s.FindElement)
	mux.HandleFunc("POST /api/control/click-element", s.ClickElement)
	mux.HandleFunc("POST /api/control/clear-element", s.ClearElement)
	mux.HandleFunc("POST /api/control/set-element-value", s.SetElementValue)
	mux.HandleFunc("POST /api/control/element-rect", s.ElementRect)
	mux.HandleFunc("POST /api/control/element-attribute", s.ElementAttribute)
	...
	mux.HandleFunc("GET /api/streams/mjpeg", s.StreamMJPEG)
